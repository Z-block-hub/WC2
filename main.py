...
kau_sau = mixer.Sound("Kau_sau.wav")
low_garn = mixer.Sound("Low_Garn.wav")
garn_sau = mixer.Sound("Garn_sau.wav")
kwun_sau = mixer.Sound("Kwun_sau.wav")
lap_sau = mixer.Sound("Lap_sau.wav")
pak_sau = mixer.Sound("Pak_sau.wav")
biu_sau = mixer.Sound("Biu_sau.wav")
gum_sau = mixer.Sound("Gum_sau.wav")

# chi sau redirections
tan = mixer.Sound("Tan.wav")
bong = mixer.Sound("Bong.wav")
gum = mixer.Sound("Gum.wav")
garn = mixer.Sound("Garn.wav")
kwun = mixer.Sound("Kwun.wav")
pak = mixer.Sound("Pak.wav")
